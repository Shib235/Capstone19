...
def app(diabetes_df):
    ...
    glucose = st.sidebar.slider('Input glucose',float(diabetes_df['Glucose'].min()),float(diabetes_df['Glucose'].max()))
    bp = st.sidebar.slider('Input blood pressure',float(diabetes_df['Blood_Pressure'].min()),float(diabetes_df['Blood_Pressure'].max()))
    insulin = st.sidebar.slider('Input insulin',float(diabetes_df['Insulin'].min()),float(diabetes_df['Insulin'].max()))
    bmi = st.sidebar.slider('Input bmi',float(diabetes_df['BMI'].min()),float(diabetes_df['BMI'].max()))
    pedigree = st.sidebar.slider('Input pedigree',float(diabetes_df['Pedigree_Function'].min()),float(diabetes_df['Pedigree_Function'].max()))
    age = st.sidebar.slider('Input age',float(diabetes_df['Age'].min()),float(diabetes_df['Age'].max()))
